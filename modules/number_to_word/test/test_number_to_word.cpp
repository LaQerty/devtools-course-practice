...
TEST(number_to_word, test_million1) {
    ...
    n.num2word();
    std::string res = n.get_word();
    ASSERT_EQ(res, "eleven  million one hundred twelve thousand three hundred twelve ");
}
...
TEST(number_to_word, first_million2) {
    ...
    n.num2word();
    std::string res = n.get_word();
    ASSERT_EQ(res, "two hundred eleven  million one hundred twelve thousand three hundred twelve ");
}
